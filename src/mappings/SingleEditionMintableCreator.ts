...
export function handleCreatedEdition (event: CreatedEdition): void {
  ...
  context.setString('tokenContract', event.params.editionContractAddress.toHexString())
  ...
  // create tokenContract
  let tokenContract = findOrCreateTokenContract(event.params.editionContractAddress.toHexString())

  tokenContract.id = event.params.editionContractAddress.toHexString()
